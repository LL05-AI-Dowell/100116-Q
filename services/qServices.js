...
export const getCheckMetaDatabaseStatus = async (workspace_id) => {
    ...
    return await qServicesAxiosInstance.get(`/v2/kitchen-sink/?type=check_metedata_database_status&workspace_id=${workspace_id}`, { headers });
};
...
export const getCheckDataDatabaseStatus = async (workspace_id, date) => {
    ...
    return await qServicesAxiosInstance.get(`/v2/kitchen-sink/?type=check_data_database_status&workspace_id=${workspace_id}&date=${date}`, { headers });
};
...
export const getUserDetails = async (workspace_id) => {
    ...
    return await qServicesAxiosInstance.get(`/v2/user-services/?type=retrieve_user_details&workspace_id=${workspace_id}`, { headers });
};
...
export const createCollection = async (dataToPost) => {
    ...
    return await qServicesAxiosInstance.post(`/v2/kitchen-sink/?type=create_collection`, dataToPost, { headers });
};
...
export const saveUserDetails = async (dataToPost) => {
    ...
    return await qServicesAxiosInstance.post(`/v2/user-services/?type=save_user_details`, dataToPost, { headers });
}
...
export const getStoreData = async (workspace_id) => {
    ...
    return await qServicesAxiosInstance.get(`/v2/store-services/?type=retrieve_store_details&workspace_id=${workspace_id}&limit=5&offset=0`, { headers });
};
...
export const createStore = async (dataToPost) => {
    ...
    return await qServicesAxiosInstance.post(`/v2/store-services/?type=create_store`, dataToPost, { headers })
}
...
export const getQrCode = async (workspace_id, user_id) => {
    ...
    return await qServicesAxiosInstance.get(`/v2/qrcode-services/?type=retrieve_qrcoderecode_details&workspace_id=${workspace_id}&user_id=${user_id}&limit=5&offset=0`, { headers });
};
...
export const getQrCodeIdBySeatNumber = async (workspace_id, seat_no) => {
    ...
    return await qServicesAxiosInstance.get(`/v2/qrcode-services/?type=retrieve_seat_details&workspace_id=${workspace_id}&seat_number=${seat_no}`, { headers });
};
...
export const createCustomerPayment = async (dataToPost) => {
    ...
    return await qServicesAxiosInstance.post(`/v2/customer-services/?type=create_customer_payment`, dataToPost, { headers });
};
...
export const updatePaymentRecord = async (paymentReceiptId, date, qrcode_id, workspace_id, seat_no) => {
    ...
    return await qServicesAxiosInstance.get(`/v2/customer-services/?type=update_payment_status&payment_receipt_id=${paymentReceiptId}&date=${date}&workspace_id=${workspace_id}&qrcode_id=${qrcode_id}&seat_number=${seat_no}`, { headers });
};
...
export const qrCodeActivationDeactivation = async (workspace_id, document_id, seat_status) => {
    ...
    return await qServicesAxiosInstance.get(`/v2/qrcode-services/?type=activate_seat&workspace_id=${workspace_id}&document_id=${document_id}&seat_status=${seat_status}`, { headers });
}
